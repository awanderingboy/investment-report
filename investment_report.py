...
자기검열 출력 형식은 아래 중 하나로 출력해라:
✅ 자기검열: 9/10 통과 (전일 정확도 X%)
⚠️ 자기검열: 6/9 통과 (최대 6/10 제한 — 전일 정확도 18%)
❌ 자기검열: 4/8 통과 — 실패 항목 있음, 보고서 수정 필요
...
- 자기검열 통과율이 정확도 패널티 적용 후 6/10 미만이면 보고서 등급 최대 75점으로 제한
- 등급 제한이 적용된 경우, 제한 사유를 보고서 등급 산정 사유에 반드시 표시해라
- 전일 정확도 18%인데 보고서 등급이 90점 이상이면 실패로 간주한다
...
자기검열 통과율이 정확도 패널티 적용 후 6/10 미만이면 보고서 등급은 최대 75점으로 제한한다.
등급 제한이 적용된 경우, 제한 사유를 보고서 등급 산정 사유에 반드시 표시해라.
전일 정확도 18%인데 보고서 등급이 90점 이상이면 실패로 간주한다.
